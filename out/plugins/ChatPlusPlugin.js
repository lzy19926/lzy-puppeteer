...
var ChatPlusPlugin = /** @class */ (function (_super) {
    ...
    //注册网页
    ChatPlusPlugin.prototype.createPage = function () {
    ...
    //打开网页
    ChatPlusPlugin.prototype.openGitLab = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    // 登录
    ChatPlusPlugin.prototype.loginGitLab = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.page)
                            return [2 /*return*/, (_a = this.client) === null || _a === void 0 ? void 0 : _a.logger.warn("No Page")];
                        return [4 /*yield*/, this.page.waitForSelector('#username')];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, this.page.waitForSelector('#password')];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.page.type('#username', this._config.username)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this.page.type('#password', this._config.password)];
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.page.waitForSelector('button')];
                    case 5:
                        _b.sent();
    ...
    // 设置屏幕大小自适应
    ChatPlusPlugin.prototype.setViewport = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var pageSize;
    ...
    return ChatPlusPlugin;
}(BasePagePlugin_1.default));
exports.ChatPlusPlugin = ChatPlusPlugin;
